# 🏦 Учёт банковских выписок и смет ТСН
...
**Веб-приложение для автоматизации учёта банковских выписок, закрывающих документов, классификации расходов по сметам и формирования отчётности с приложениями.**
...
- **Формирование отчётов в PDF** — отчет для ревизионной комиссии, судов, экспертиз: таблица операций, по каждой указывается ссылка на приложения, а в конец файла добавляются все приложения
